...
```r
favorite_superhero <- filter(superhero_powers, hero_names=="Carnage")
favorite_superhero
```
...
```r
filter(superhero_info, name=="Carnage")   
```
...
##   name   gender eye_color race  hair_color height publisher skin_color alignment
##   <chr>  <chr>  <chr>     <chr> <chr>       <dbl> <chr>     <chr>      <chr>    
## 1 Carna… Male   green     Symb… Red           185 Marvel C… <NA>       bad      
## # ℹ 1 more variable: weight <dbl>
```

...
```
## here() starts at C:/Users/boy/Desktop/BIS15W2024_rchu
```
...
The data is tidy as each variable has its own column. This data is in long format. 
...
## # A tibble: 66 × 3
## # Groups:   site [11]
##    site         year  mean_enterocci_cfu_100ml
##    <chr>        <chr>                    <dbl>
...
```r
mean_enterococci %>%
  pivot_wider(names_from = "year", values_from = "mean_enterocci_cfu_100ml")
```
